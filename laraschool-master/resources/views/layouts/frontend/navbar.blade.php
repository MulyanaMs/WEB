<div class="clever-main-menu">
    <div class="classy-nav-container breakpoint-off">
        ...
        <nav class="classy-navbar justify-content-between" id="cleverNav">
            ...
            <!-- Logo -->
            <a class="nav-brand" href="/"><img src="{{ asset('img/icons') }}/LARAVEL.jpg" width="50" alt=""> GARUDA SCHOOL</a>
            ...
            <div class="classy-menu">
                ...
                <div class="classynav">
                    <ul>
                        ...
                        <li><a href="{{ route('agenda') }}" class="{{ Request::is('agenda') ? 'text-primary' : '' }}">Agenda</a></li>
                    </ul>
